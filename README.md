...
5. (Just for fun) Continue developing code that transfers a Habitat trained agent to the real world (pyrobot is also working on this). I created a proof of concept script in habitat-api/habitat_baselines  in June 2019, but the code might be outdated
